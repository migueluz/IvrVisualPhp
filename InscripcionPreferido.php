...
<?php
  ...
  if (isset($next) && $next == $page)
	...
	switch ($input) {
    	case 1:
    		$next = "IngresarElegido";
    		$operacion="Ingresa Menu Registro Elegido";
    		break;
    	case 2:
    		$next = "SoporteTecnico1";
    		$operacion="Solitar Soporte Tecnico";
    		break;
...
logger('InscripcionPreferido',$caller,$operacion,$called);
  }
  else
  {
